...
//  Crear Recibo Pago (PDF)
const crearReciboPago = async (client) => {
    ...
    let body = {
        "clientId": idCRM,
        "name": `Recibo de Pago,C.A - ${nombre.toUpperCase()} ${apellido.toUpperCase()}.pdf`,
        "templateId": 3
    }
    let headers = {
...
module.exports = crearReciboPago