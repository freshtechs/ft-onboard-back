...
function soporteEmailTemplate(client, reporteCrmPath) {
    const {
        nombre, apellido, serviciosContratados, nombreDeVivienda, numeroDeVivienda,
        fechaDeInstalacion, serialONU, macONU, macRouterCliente
    } = client;
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 3em; text-align: center;">
                                        ...
                                        <h3 style="color: gray">Serial ONU: </h3><h3 style="color: black;">${serialONU} </h3>
                                        <h3 style="color: gray">MAC ONU: </h3><h3 style="color: black;">${macONU}</h3>
                                        <h3 style="color: gray">MAC Router Cliente: </h3><h3 style="color: black;">${macRouterCliente}</h3>
                                    </div>
                                </td>
                            </tr>
                        </table>
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="text-services">
                                                            ...
                                                            <p><a href="${reporteCrmPath}" class="btn btn-primary">Ver
                                                                    Reporte</a></p>
                                                        </td>
                                                    </tr>
                                                </table>
...
module.exports = soporteEmailTemplate