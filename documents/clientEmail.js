function clientEmail(client, contratoCrmPath, reporteCrmPath, bienvenidaCrmPath) {
    const { nombre, apellido } = client;
    return `
    <!DOCTYPE html>
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    <td valign="middle" class="hero bg_white"
                        style="background-image: url(https://drive.google.com/uc?export=download&id=1Q4A35od5ZN9AZzfkzCLKlE-PcHSc9zF0); background-size: cover; height: 360px;">
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 3em; text-align: center;">
                                        ...
                                        <h3 style="color: white">¡Le damos la bienvenida a Fresh Techs! Estamos muy
                                            emocionados de brindarle
                                            el mejor
                                            servicio de internet de alta velocidad.</h3>
                                        ...
                                        <tr>
                                            <td valign="top" width="33.333%" style="padding-top: 20px;"
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="icon">
                                                            <img src='https://drive.google.com/uc?export=download&id=16YUN3XolyugyLJFmAM5HqO1zWX4Mitgc'
                                                                alt=""
                                                    ...
                                                    <tr>
                                                        <td class="text-services">
                                                            <h3>Contrato</h3>
                                                            <p>Le invitamos a revisar su contrato de servicio para
                                                                asegurarse de que toda la información sea correcta.</p>
                                                            <p><a href="${contratoCrmPath}"
                                            ...
                                            <td valign="top" width="33.333%"
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="icon">
                                                            <img src='https://drive.google.com/uc?export=download&id=1y3c_biB4UdNPgzaL5RGTJGonLyhFvCEt'
                                                                alt=""
                                                                style="width: 60px; max-width: 600px; height: auto; margin: auto; display: block;">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-services">
                                                            <h3>Reporte de Instalación</h3>
                                                            <p>Revise los detalles completos de su instalación,
                                                                hecha por nuestro equipo técnico.
                                                            </p>
                                                            <p><a href="${reporteCrmPath}"
                                                                    class="btn btn-primary">Ver Reporte</a></p>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td valign="top" width="33.333%" style="padding-top: 20px;"
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="text-services">
                                                            <h3>Información</h3>
                                                            <p>¡Contáctenos para solicitudes y descubra los medios de
                                                                pago disponibles para usted!</p>
                                                            <p><a href="${bienvenidaCrmPath}"
                                                                    class="btn btn-primary">Ver Información</a>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </table>
